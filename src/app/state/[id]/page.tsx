            ...
            <section className="grid md:grid-flow-col gap-4 md:grid-cols-12">
                <div className="grid gap-4 md:col-span-3 content-start h-fit bg-gray-200">
                    <div className="md:hidden px-4">
                        <p>All Areas &gt; statename</p>
                        <h1 className="text-2xl md:text-4xl font-bold">State</h1>
                        <div className="flex flex-row items-center">
                            <p className="pr-4">GPS:</p>
                            <p>438576347856-3748563847</p>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div className="flex flex-row items-center p-2">
                            <h4 className="px-2 font-semibold">Indian Creek</h4>
                        ...
                        <div className="flex flex-row items-center bg-gray-200 p-2">
                            <h4 className="px-2 font-semibold">Indian Creek</h4>
                            <p className="text-xs">87 routes</p>
                        </div>                        <div className="flex flex-row items-center bg-gray-200 p-2">
                            <h4 className="px-2 font-semibold">Indian Creek</h4>
                            <p className="text-xs">87 routes</p>
                        </div>                        <div className="flex flex-row items-center bg-gray-200 p-2">
                            <h4 className="px-2 font-semibold">Indian Creek</h4>
                ...
                <div className="grid md:grid-cols-2 md:col-span-9 md:row-span-1 gap-4">
                    <div className="grid md:col-span-1 h-fit gap-8">
                        ...
                        <div className="px-4">
                            ...
                            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Pariatur reiciendis ipsum aliquid enim ex consectetur, porro praesentium quia. Illo magnam et quaerat, vel commodi animi eum ipsum omnis dolorum provident!</p>
                        </div>
                    </div>
